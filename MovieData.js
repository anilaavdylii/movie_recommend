export const data = [
  {
    ...
    link:
      "https://theflixer.tv/movie/watch-underdog-full-12002",
    favorite: true,
    ratings: [
      {
  ...
  },
  {
    ...
    link:
        "https://theflixer.tv/movie/watch-honest-thief-full-63718",
    ratings: [
      {
        "Source": "Internet Movie Database",
        "Value": "9"
  ...
  },
  {
    ...
    link:
      "https://theflixer.tv/movie/watch-deadpool-full-19694",
    favorite: true,
    ratings: [
      {
        "Source": "Internet Movie Database",
  ...
  },
  {
    ...
    link:
      "https://theflixer.tv/movie/watch-bruce-almighty-full-19518",
    favorite: true,
    ratings: [
      {
        "Source": "Internet Movie Database",
